...
//            this is the first time starting the game, set initial values
    ...
    void createImages() {
        ...
        scoreImg = new Image(new Texture("Buttons/Gameplay_Buttons/Score.png"));
    }

    void createBtnAndAddListener() {
        pauseBtn = new ImageButton(new SpriteDrawable(new Sprite(
                new Texture("Buttons/Gameplay_Buttons/Pause.png"))));
    ...
    void createPausePanel() {
        ...
        pausePanel = new Image(new Texture("Buttons/Pause/Pause_Panel.png"));
        ...
        quitBtn = new ImageButton(new SpriteDrawable(new Sprite(
                new Texture("Buttons/Pause/Quit_2.png"))));
    ...
    public void createGameOverPanel() {
        ...
        Image gameOverPanel = new Image(new Texture("Buttons/Pause/Show_Score.png"));
